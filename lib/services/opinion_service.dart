...
class OpinionService {
  ...
  // Fetch the latest Opinion by ID from Firestore
  Future<Opinion?> getOpinion(String id) async {
    final doc = await _opinionsRef.doc(id).get();
    if (!doc.exists) return null;
    return Opinion.fromMap(doc.data() as Map<String, dynamic>);
  }
  ...
  // ...existing methods for upvote, unUpvote, downvote, unDownvote, agree, etc...
